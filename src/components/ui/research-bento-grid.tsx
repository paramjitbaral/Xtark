  ...
  return (
    <section
      ...
      className={cn(
        ...
        "dark:border-[#292929] dark:bg-black dark:shadow-[inset_0_1px_rgba(255,255,255,0.02),0_12px_32px_rgba(0,0,0,0.22)]",
        className,
      )}
    >
      {children}
...
function FeatureCopy({ title, children, className }: { title: React.ReactNode; children: React.ReactNode; className?: string }) {
  return (
    <div className={cn("absolute inset-x-0 bottom-0 z-20", className)} style={{ paddingLeft: '40px', paddingRight: '40px', paddingBottom: '40px' }}>
      <h3 className="text-[20px] font-semibold leading-[1.08] tracking-[-0.045em] text-zinc-950 sm:text-[22px] dark:text-[#f1f1f1]">{title}</h3>
      <p className="max-w-[360px] text-[14px] leading-[1.45] tracking-[-0.015em] text-zinc-600 sm:text-[15px] dark:text-[#858585]" style={{ marginTop: '16px' }}>{children}</p>
    </div>
  );
}
...
function DesignsPanel({
  ...
  return (
    <Panel className="min-h-[350px] sm:min-h-[320px] @min-[840px]:col-span-12 @min-[840px]:min-h-[302px] @min-[840px]:row-span-1">
      ...
      />
      <div aria-hidden className="pointer-events-none absolute inset-x-0 top-0 h-[76%] bg-[radial-gradient(ellipse_at_50%_18%,transparent_12%,rgba(247,247,245,.12)_58%,#f7f7f5_100%)] dark:bg-[radial-gradient(ellipse_at_50%_18%,transparent_12%,rgba(0,0,0,.5)_58%,#000000_100%)]" />
...
function InvoicePanel({ monthlyPrice, previousPrice, currency, locale, autoPlay, title, description }: InvoicePanelProps) {
  ...
  return (
    <Panel className="min-h-[420px] [container-type:inline-size] sm:min-h-[360px] @min-[840px]:col-span-7 @min-[840px]:min-h-[302px] @min-[840px]:row-span-1">
      ...
      <div
        aria-hidden
        className="pointer-events-none absolute inset-x-0 bottom-0 z-10 h-[48%] bg-[linear-gradient(to_bottom,rgba(247,247,245,0)_0%,rgba(247,247,245,.12)_24%,rgba(247,247,245,.48)_58%,rgba(247,247,245,.88)_86%,#f7f7f5_100%)] dark:bg-[linear-gradient(to_bottom,rgba(0,0,0,0)_0%,rgba(0,0,0,.12)_24%,rgba(0,0,0,.48)_58%,rgba(0,0,0,.88)_86%,#000000_100%)]"
      />
      <div
        aria-hidden
        className="pointer-events-none absolute inset-x-[-8%] -bottom-[24%] z-10 h-[48%] rounded-[50%] bg-[#f7f7f5]/75 blur-[38px] dark:bg-black/75"
      />
      <div
        aria-hidden
...
export function ResearchBentoGrid({
  ...
  return (
    <div
      {...props}
      className={cn(
        "flex justify-center items-center h-full w-full bg-transparent p-2 text-zinc-950 [--bento-tile-cutout:#e4e4e1] [container-type:inline-size] sm:p-3",
