      ...
      >
        ...
        <div style={{ textAlign: 'center', marginBottom: '44px' }}>
          ...
          >
            ...
            <span style={{ color: '#5e5e5e', fontSize: '11px', fontWeight: 600, letterSpacing: '0.12em', textTransform: 'uppercase', fontFamily: 'monospace' }}>
              Instant Estimation
            </span>
          </div>
          ...
          >
            Estimate your project investment in seconds
          </h2>
        </div>
